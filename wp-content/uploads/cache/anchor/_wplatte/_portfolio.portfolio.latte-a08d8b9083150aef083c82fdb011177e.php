<?php //netteCache[01]000579a:2:{s:4:"time";s:21:"0.77830300 1701871230";s:9:"callbacks";a:4:{i:0;a:3:{i:0;a:2:{i:0;s:6:"NCache";i:1;s:9:"checkFile";}i:1;s:93:"C:\xampp\htdocs\turismo\wp-content\themes\anchor\ait-theme\elements\portfolio\portfolio.latte";i:2;i:1468282814;}i:1;a:3:{i:0;a:2:{i:0;s:6:"NCache";i:1;s:10:"checkConst";}i:1;s:20:"NFramework::REVISION";i:2;s:22:"released on 2014-08-28";}i:2;a:3:{i:0;a:2:{i:0;s:6:"NCache";i:1;s:10:"checkConst";}i:1;s:15:"WPLATTE_VERSION";i:2;s:5:"2.9.0";}i:3;a:3:{i:0;a:2:{i:0;s:6:"NCache";i:1;s:10:"checkConst";}i:1;s:17:"AIT_THEME_VERSION";i:2;s:4:"1.66";}}}?><?php

// source file: C:\xampp\htdocs\turismo\wp-content\themes\anchor\ait-theme\elements\portfolio\portfolio.latte

?><?php
// prolog NCoreMacros
list($_l, $_g) = NCoreMacros::initRuntime($template, '0u2j0pi5jt')
;
// prolog NUIMacros
...
// main template
//
NCoreMacros::includeTemplate($el->common('header'), $template->getParameters(), $_l->templates['0u2j0pi5jt'])->render() ?>
...
<?php $width = $height = round(($maxW - (($el->option->columns) * $el->option->imageOffset)) / $el->option->columns) ;if ((($width+$el->option->imageOffset) * $el->option->columns) > $maxW) { $width = $width - 1 ;} ?>
...
<?php $meta = $item->meta('portfolio-item') ?>
...
<?php if ($meta->type == 'image' and $el->option->display == 'colorbox' and $item->hasImage) { $url = $item->imageUrl ;} elseif ($meta->type == 'video' and $el->option->display == 'colorbox' and $meta->videoUrl) { $url = $meta->videoUrl ;} elseif ($meta->type == 'website' and $el->option->display == 'colorbox') { $url = $meta->websiteUrl ;} else { $url = $item->permalink ;} ?>
					...
					<a href="<?php echo NTemplateHelpers::escapeHtml($url, ENT_COMPAT) ?>" class="disable-default-colorbox" <?php if ($meta->type == 'website' and $el->option->display == 'colorbox' and $meta->linkTarget) { ?>
...
<?php } ?>
						...
						<div<?php if ($_l->tmp = array_filter(array('portfolio-item-icon', !$el->option->imageDescription ? 'no-excerpt':null))) echo ' class="' . NTemplateHelpers::escapeHtml(implode(" ", array_unique($_l->tmp)), ENT_COMPAT) . '"' ?>>
...
<?php } else { ?>
										...
										<span class="button"><?php echo NTemplateHelpers::escapeHtml(__('View more', 'wplatte'), ENT_NOQUOTES) ?></span>
...
<?php NCoreMacros::includeTemplate(WpLatteMacros::getTemplatePart("ait-theme/elements/portfolio/javascript", ""), array() + get_defined_vars(), $_l->templates['0u2j0pi5jt'])->render() ;